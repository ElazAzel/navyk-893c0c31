...
import { Home, MessageSquare, FileText, Briefcase, Users, User, LogOut } from "lucide-react";
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-50">
        <div className="flex justify-around items-center h-16 max-w-screen-xl mx-auto px-2">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-1 flex-1 h-full transition-base text-destructive hover:text-destructive/80"
          >
